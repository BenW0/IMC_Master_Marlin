...
#include "imc_i2c_message_constants.h"
...
//imc_return_type imc_send_init_one(uint8_t motor_id, uint16_t host_revision, uint16_t *slave_hw_ver, uint16_t *slave_fw_ver, 
...
//=== TODO: Need to split this out so length and rates can be per-axis.
